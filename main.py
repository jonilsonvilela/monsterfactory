...
async def start_analysis(
    ...
    form_type: str = Form(None) # Opcional, dependendo do assistente
):
    ...
    if assistant_type == "analise_sumula":
        if not form_type:
            raise HTTPException(status_code=400, detail="Para 'analise_sumula', o 'form_type' é obrigatório.")

        jobs[job_id]["form_type"] = form_type
